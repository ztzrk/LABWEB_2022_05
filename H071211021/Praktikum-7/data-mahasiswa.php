...
<html lang="en">
  ...
  <body>
    ...
    <?php include 'login-proccess.php'; ?>
    ...
    <div class="container" id="outer">
      ...
      <?php endif ?>
      <form action="login-proccess.php" method="POST" class="logout-email">
        <button type="submit" class="btn btn-danger" name="keluar">Logout</button>
      </form>
            ...
            <?php
              ...
              <tr>
                ...
                <td class="row justify-content-center">
                  <a href="data-mahasiswa.php?edit=<?php echo $line['id']; ?>" class="col btn btn-warning" id="edit-button">Edit</a>
